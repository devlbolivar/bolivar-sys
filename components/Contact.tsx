...
export default function Contact() {
  ...
  const focus = (e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    e.target.style.borderColor = Am(0.48)
  }
  const blur = (e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    e.target.style.borderColor = Am(0.15)
  }
      ...
      >
        ...
        <FadeIn delay={0.15}>
          ...
          >
            ...
            />
            <input
              placeholder="tipo de proyecto  (shopify · landing · ia · retainer)"
              style={iS}
              onFocus={focus}
              onBlur={blur}
            />
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 700,
                letterSpacing: 0.5,
                boxShadow: `0 0 32px ${Am(0.28)}`,
                transition: 'box-shadow .2s',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = `0 0 56px ${Am(0.48)}`
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = `0 0 32px ${Am(0.28)}`
              }}
            >
              ENVIAR MENSAJE →
            </button>
