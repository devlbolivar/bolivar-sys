    ...
    >
      ...
      <div style={{ position: 'relative' }}>
        ...
        >
          ...
          <br />
          <span style={{ color: Am(0.28) }}>&gt; CARGANDO SERVICIOS...</span>
          <br />
          ...
          <a href="#contacto">
            <button
              style={{
                ...
                ...grot,
                fontWeight: 700,
                boxShadow: `0 0 36px ${Am(0.3)}`,
                transition: 'box-shadow .2s',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = `0 0 60px ${Am(0.52)}`
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = `0 0 36px ${Am(0.3)}`
              }}
            >
              Iniciar Proyecto →
            </button>
        ...
        >
          {[
            ...
            >
              <div style={{ ...mono, fontSize: 18, color: A, fontWeight: 700 }}>
                {v}
              </div>
              <div style={{ fontSize: 11, color: Am(0.38), marginTop: 3 }}>
                {l}
              </div>
            </div>
          ))}
      ...
      >
        ...
        >
          ...
          <span style={{ marginLeft: 8, color: Am(0.28), fontSize: 11 }}>
            bolivar-sys.sh
          </span>
        </div>
        ...
        <div style={{ padding: '26px 30px' }}>
          <div style={{ color: Am(0.55) }}>
            ${' '}
            <span style={{ color: A }}>bolivar</span> --services
          </div>
          ...
          <div style={{ marginTop: 10, color: Am(0.55) }}>
            ${' '}
            <span style={{ color: A }}>status</span> --check
          </div>
          <div style={{ color: '#22C55E' }}>
            ✓ on-time: 100% &nbsp;·&nbsp; rating: 4.9/5
          </div>
